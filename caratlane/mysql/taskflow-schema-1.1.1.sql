...
-- =====================================================================
-- Name         : taskflow-schema-1.1.1.sql
...
--
-- 30-05-2016  WD
--      Added procedures getIndicators, getHC, getHP.
-- 16-05-2016  WD
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getPC` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER = CURRENT_USER PROCEDURE `getPC`(project_id INT(11))
BEGIN
    ...
    IF @max IS NOT NULL THEN
        ...
        -- serialize the result set
        SELECT `daily_product_completed`, PCi FROM (

        -- arithmetic progression --------
        SELECT  `daily_product_completed`, @sum_product_completed := @sum_product_completed + `daily_product_completed` AS PCi
        -- -------------------------------
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getPP` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER = CURRENT_USER PROCEDURE `getPP`(project_id INT(11))
BEGIN
...
-- Dump completed on 2016-05-31  0:51:01
