	...
	angular
	  ...
	  .directive('mwlCalendarMonth', ["calendarUseTemplates", function(calendarUseTemplates) {
	    ...
	    return {
	      ...
	      link: function(scope, element, attrs, profileCalendarCtrl) {
	        scope.vm.profileCalendarCtrl = profileCalendarCtrl;
	      },
	      bindToController: true
	    };
