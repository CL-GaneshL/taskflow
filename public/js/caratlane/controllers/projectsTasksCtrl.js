...
app.controller(
        ...
        [
            ...
            'projectsTasksSrvc',
            'modalSrvc',
            function ($log, $scope, $uibModal, holidaysSrvc, tasksSrvc, projectsTasksSrvc, modalSrvc) {

                var CONTROLLER_NAME = 'projectsTasksCtrl';
                ...
                $scope.changeProject = function () {
                    ...
                    buildEventList(nwds, holidays, tasks, $scope.filter_project, $scope.filter_employee);
                };
   ...
   // -------------------------------------------------------------
   var   nb_products = '1';
   var nb_products_choices =  tasksSrvc.getCompletionChoices();
   // -------------------------------------------------------------
   ...
   // -------------------------------------------------------------
                            ...
                            $scope.update = function () {
                                ...
                                taskPromise.then(
                                        function (response) {
                                            ...
                                            // and rebuild the list
                                            buildEventList(nwds, holidays, tasks, filter_project, filter_employee);
                ...
                function addTasksEvent(events, tasks, filter_project, filter_employee) {
                    ...
                    for (index = 0; index < tasks.length; index++) {
                        ...
                        var employement_type = null;    // dont need it at the moment !
