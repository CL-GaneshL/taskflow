...
<div class="container-fluid container-fullw bg-white no-border">
    ...
    <div class="modal-header col-md-12">
        <h3 class="modal-title">Task's completion update</h3>
    </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-9">
                        <select class="form-control cs-select cs-skin-elastic" 
                                ng-model="completion"
                                ng-app=""
                                ng-options="choice for choice in completion_choices" >
                            <option value="" disabled=""><% completion %></option>
                        </select>
                    </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <div class="col-md-9">
                        <select class="form-control cs-select cs-skin-elastic" 
                                ...
                                ng-app=""
                                ng-options="choice for choice in nb_products_choices" >
                            <option value="" disabled=""><% nb_products_completed %></option>
                        </select>
                    </div>
